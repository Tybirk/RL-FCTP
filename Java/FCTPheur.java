...
{     
  ...
  public void improveSolution( )
  {
    ...
    for ( int run=0; run < FCTPparam.num_runs; run++ )
    {
      ...
      {
        case FCTPparam.LOCALSEARCH: LocalSearch(); break;
        case FCTPparam.ILS: ILS(); break;
        case FCTPparam.MSLS: MSLS(); break;
        case FCTPparam.SA: SA(); break;
        case FCTPparam.SA_OSMAN: OsmanSA(); break;
        case FCTPparam.RTR: RTR_proc( ); break;
        case FCTPparam.RTR_ILS: RTR_proc( ); break;
        case FCTPparam.RTR_VNS: RTR_proc( ); break;
        case FCTPparam.ILS_RTR: ILS(); break;
        case FCTPparam.RTRJ: RTR_Jeanne( ); break;
        case FCTPparam.GLS: GLS(); break;
        case FCTPparam.VNS: VNS(); break;
        case FCTPparam.VNS_RTR: VNS( ); break;
        case FCTPparam.GRASP: Grasp(); break;
        case FCTPparam.ANTS: AntColony(); break;
        case FCTPparam.EA: EA(); break;
        case FCTPparam.EXTSS: extSS_SCS(); break;
        case FCTPparam.ALTSS: altSS_SCS(); break;
        case FCTPparam.TS: TS(); break;
        case 50: IRNLS(0); break;
        case 51: IRNLS_v2(0); break;
        case 52: int[] population_sizes = new int[2];  population_sizes[0] = 100; population_sizes[1] = 20;
                 int[] max_runs = new int[2]; max_runs[0] = 600; max_runs[1] = 800;
                 PIRNLS(population_sizes, max_runs); break;
        case 53: int[] population_sizes2 = new int[3];  population_sizes2[0] = 300; population_sizes2[1] = 50; population_sizes2[2] = 20;
                 int[] max_runs2 = new int[3]; max_runs2[0] = 200; max_runs2[1] = 800; max_runs2[2] = 1000;
                 PIRNLS(population_sizes2, max_runs2); break;
      ...
      if( FCTPparam.impMethod == 52 || FCTPparam.impMethod == 53 || FCTPparam.impMethod == 56 ) break;
    }    
