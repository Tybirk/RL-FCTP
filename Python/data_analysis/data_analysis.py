...
def action_analysis(actions, k):
    ...
    sns.set_style('ticks')
    sns.set_palette((sns.cubehelix_palette(k, start=2, rot=0, dark=0.5, light=.95,
                                           reverse=True)))  # pastal,  muted, dark, deep, colorblind, bright, Reds
...
if __name__ == "__main__":
    ...
    visualize_relative_performance(results_final, results_dictionary_buson, ub, names,
                                   fname='/home/tybirk/Desktop/Speciale/FCTP/Plots/rel_perf_mine.eps',
                                   compare_to_min=True)
    visualize_relative_performance(results_dictionary_buson, results_final, ub, names,
                                   fname='/home/tybirk/Desktop/Speciale/FCTP/Plots/rel_perf_buson.eps',
                                   compare_to_min=True)
    visualize_relative_performance(results_final, results_dictionary_buson, ub, names,
                                   fname='/home/tybirk/Desktop/Speciale/FCTP/Plots/rel_perf_diff.eps')
